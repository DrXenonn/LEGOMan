...
public class PlayerController : MonoBehaviour, IPlayerController
{
    ...
    private void Awake()
    {
        ...
        _scaleFactor = 0.2f;
        _size = _col.size;
        _adjustedSize = new Vector2(_size.x * _scaleFactor, _size.y * _scaleFactor);
        _adjustedDistance = _stats.GrounderDistance * _scaleFactor;
    }
    ...
    private void CheckCollisions()
    {
        ...
        // Ground and Ceiling
        _groundHit = Physics2D.CapsuleCast(bounds.center, _adjustedSize, _col.direction, 0, Vector2.down,
            _adjustedDistance, ~_stats.PlayerLayer);
        bool ceilingHit = Physics2D.CapsuleCast(bounds.center, _adjustedSize, _col.direction, 0, Vector2.up,
            _adjustedDistance, ~_stats.PlayerLayer);
